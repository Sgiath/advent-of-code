defmodule AdventOfCode.Year2021.Day02.Test do
  ...
  describe "part 1" do
    ...
    test "bitstring" do
      assert Day02.part1(@test_input, &Day02.count_reducer1/2) == 150
      assert Day02.part1(Day02.input(), &Day02.count_reducer1/2) == 2_272_262
    end

    test "first_letter" do
      assert Day02.part1(@test_input, &Day02.count_reducer2/2) == 150
      assert Day02.part1(Day02.input(), &Day02.count_reducer2/2) == 2_272_262
    end

    test "length" do
      assert Day02.part1(@test_input, &Day02.count_reducer3/2) == 150
